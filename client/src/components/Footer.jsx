    ...
    <footer className="relative mt-16 overflow-hidden bg-[#0f172a]/95 backdrop-blur-3xl border-t border-white/10 font-sans pt-16 pb-8">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-black text-xl mb-6 text-white tracking-tighter leading-none">{t('nav.home')}</h4>
          ...
          {/* Support */}
          <div>
            <h4 className="font-black text-xl mb-6 text-white tracking-tighter leading-none">{t('common.contactUs')}</h4>
          ...
          {/* Follow Us */}
          <div>
            <h4 className="font-black text-xl mb-6 text-white tracking-tighter leading-none">{t('common.followUs')}</h4>
            <div className="flex gap-3">
              <a href="#" className="group relative overflow-hidden p-3 bg-white/5 hover:bg-orange-500 rounded-xl border border-white/10 transition-all duration-300 hover:shadow-[0_0_20px_rgba(249,115,22,0.4)] hover:-translate-y-1 glass-sheen">
