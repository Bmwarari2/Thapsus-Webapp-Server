  ...
  return (
    <div className="min-h-screen relative bg-white/[0.03] overflow-hidden py-12 px-4 font-sans">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-black text-white mb-4 leading-none tracking-tighter">
            {t('warehouse.title')}
          </h1>
          <p className="text-mute font-medium text-lg">
        ...
        <div className="space-y-8 mb-12">
          {Object.entries(resolvedAddresses).map(([market, data]) => (
            <div key={market} className="bg-surface-2 backdrop-blur-2xl border border-line shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl p-8 relative overflow-hidden glass-sheen transition-transform duration-300 hover:-translate-y-1">
              <div className="flex flex-col sm:flex-row sm:items-start gap-4 mb-6 relative z-10">
                ...
                <div>
                  ...
                  <p className="text-mute font-semibold tracking-tight">
                    Your unique warehouse address in {data.label}
                  </p>
                </div>
              </div>

              <div className="bg-surface-2 backdrop-blur-md border border-line rounded-xl p-6 mb-6 shadow-sm relative z-10">
                {/* Personal identifiers */}
                <p className="font-mono text-sm md:text-base text-ember-400 font-black mb-1">
                  {user?.name}
                </p>
                <p className="font-mono text-sm md:text-base text-ember-400 font-black mb-3">
                  {tcCode}
                </p>
                {/* Warehouse address lines */}
                {data.lines.map((line, i) => (
                  <p key={i} className="font-mono text-sm md:text-base text-white font-bold leading-relaxed">
                    {line}
                  </p>
                ))}
                <p className="text-xs text-dim font-semibold mt-3">
              ...
              <div className="flex gap-4 flex-wrap relative z-10">
                <button
                  ...
                  className="group relative overflow-hidden bg-ember-gradient text-white px-6 py-3.5 rounded-xl font-black tracking-tight flex items-center gap-2 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-0.5 glass-sheen"
              ...
              <div className="mt-8 pt-6 border-t border-line relative z-10">
                <h3 className="text-sm font-black text-dim uppercase tracking-widest mb-4">
                  ...
                  {market === 'UK' && (
                    <>
                      <li className="flex gap-3 items-start">
                        <span className="text-ember-400 text-lg leading-none mt-0.5">•</span>
        ...
        <div className="group relative overflow-hidden bg-surface/90 backdrop-blur-2xl border border-line rounded-[24px] p-8 md:p-10 text-white shadow-2xl mb-8 transition-transform duration-500 hover:-rotate-1 hover:scale-[1.02] transform perspective-1000 glass-sheen">
          ...
          <div className="relative z-10">
            ...
            <ol className="space-y-5 text-mute font-medium">
              <li className="flex gap-4 items-start bg-white/5 p-4 rounded-xl border border-line backdrop-blur-sm">
        ...
        <div className="rounded-2xl">
          <div className="bg-surface border border-line shadow-card rounded-2xl p-8 md:p-10">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-emerald-800 font-semibold relative z-10">
              <li className="flex gap-3 items-start bg-surface-2 p-4 rounded-xl border border-line backdrop-blur-sm">
