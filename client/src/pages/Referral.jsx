  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] font-sans text-slate-900 overflow-x-hidden relative pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 relative z-10">
            ...
            <div className="w-full lg:w-auto lg:border-l border-slate-200/50 lg:pl-10 pt-8 lg:pt-0 border-t lg:border-t-0">
              ...
              <div className="grid grid-cols-2 gap-4 w-full lg:min-w-[320px]">
                <button onClick={handleShareWhatsApp}
                  className="bg-white/80 hover:bg-white backdrop-blur-md border border-green-200 text-slate-700 px-4 py-4 rounded-2xl font-bold flex items-center justify-center gap-2 text-xs md:text-sm transition-colors shadow-sm hover:shadow-green-100">
                  <MessageCircle size={18} className="text-green-500" /> WhatsApp
                </button>
                <button onClick={handleShareEmail}
                  className="bg-white/80 hover:bg-white backdrop-blur-md border border-blue-200 text-slate-700 px-4 py-4 rounded-2xl font-bold flex items-center justify-center gap-2 text-xs md:text-sm transition-colors shadow-sm hover:shadow-blue-100">
                  <Mail size={18} className="text-blue-500" /> Email
                </button>
                <button onClick={handleCopyLink}
                  className="bg-white/80 hover:bg-white backdrop-blur-md border border-purple-200 text-slate-700 px-4 py-4 rounded-2xl font-bold flex items-center justify-center gap-2 text-xs md:text-sm transition-colors shadow-sm hover:shadow-purple-100">
        ...
        <div className="relative group overflow-hidden rounded-[2.5rem] bg-[#0f172a] p-10 md:p-16 text-white shadow-2xl flex flex-col transition-all hover:scale-[1.01] mx-2 md:mx-0">
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div className="flex flex-col md:flex-row gap-5 text-center md:text-left items-center md:items-start">
                <div className="w-14 h-14 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center justify-center font-black text-xl shrink-0 text-orange-400 shadow-inner">1</div>
                <div>
                  <p className="font-black text-xl mb-3 tracking-tight">Share Your Code</p>
                  <p className="text-sm md:text-base text-slate-400 font-medium leading-relaxed">Send your unique referral code to friends via WhatsApp, email, or a direct link.</p>
                </div>
              </div>
              <div className="flex flex-col md:flex-row gap-5 text-center md:text-left items-center md:items-start">
                <div className="w-14 h-14 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center justify-center font-black text-xl shrink-0 text-orange-400 shadow-inner">2</div>
                <div>
                  <p className="font-black text-xl mb-3 tracking-tight">They Sign Up</p>
                  <p className="text-sm md:text-base text-slate-400 font-medium leading-relaxed">Your friend creates a Thapsus Cargo account using your referral code.</p>
                </div>
              </div>
              <div className="flex flex-col md:flex-row gap-5 text-center md:text-left items-center md:items-start">
