      ...
      <div className="max-w-3xl mx-auto px-6 py-12 lg:py-20 relative z-10">
        ...
        <GlassCard className="p-8 md:p-12">
          ...
          <Section title="9. Data Deletion Instructions" id="data-deletion">
            ...
            <ul className="list-disc pl-5 space-y-1.5 mt-2">
              <li><strong className="text-white">By email</strong> — send a request to <a href="mailto:admin@thapsus.uk" className="text-ember-400 hover:underline font-bold">admin@thapsus.uk</a> with the subject "Data deletion request", including the phone number you use with us. Deletion runs after a 14-day cooling-off period, during which you can cancel, and you can ask for an export of your data first.</li>
