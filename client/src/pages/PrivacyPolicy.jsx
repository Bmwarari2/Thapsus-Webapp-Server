        ...
        <GlassCard className="p-8 md:p-12">
          ...
          <Section title="1. Information We Collect">
            ...
            <ul className="list-disc pl-5 space-y-1.5 mt-2">
              ...
              <li><strong className="text-white">Communications</strong> — messages you send via our support ticket system or email.</li>
            </ul>
          ...
          <Section title="6. Your Rights">
            ...
            <p className="mt-3">To exercise any of these rights, contact us at <a href="mailto:admin@thapsus.uk" className="text-ember-400 hover:underline font-bold">admin@thapsus.uk</a>.</p>
          </Section>
