...
export const NewOrder = () => {
  ...
  const inputClass = "w-full px-6 py-4 bg-surface-2 backdrop-blur-md border border-line rounded-[1.5rem] focus:outline-none focus:ring-2 focus:ring-ember-500/30 focus:border-ember-500 text-white font-bold placeholder-white/30 transition-all shadow-sm";
  const labelClass = "block text-[10px] font-black uppercase tracking-widest text-mute mb-2 ml-2";
    ...
    <div className="min-h-screen bg-transparent font-sans text-white overflow-x-hidden relative pb-24">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 relative z-10">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-mute font-bold max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3 mt-3">
                    <label className="flex items-center gap-3 cursor-pointer p-3 rounded-2xl border border-line bg-surface-2 hover:bg-surface-2 transition-colors">
                      ...
                      <span className="text-white font-bold text-sm">{t('neworder.insurance')}</span>
                    </label>
                    {formData.insurance && (
                      <div className="animate-in fade-in zoom-in-95 duration-200 mt-2">
                        <label className="block text-[10px] font-black uppercase tracking-widest text-mute mb-2 ml-2">Declared Value (KES)</label>
                ...
                <div className="pt-6">
                  <button type="submit" disabled={loading}
                    className="w-full glass-sheen bg-surface hover:bg-slate-800 text-white px-6 py-5 rounded-[1.5rem] font-black uppercase tracking-widest text-xs transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-xl hover:-translate-y-1 flex items-center justify-center gap-2">
                    {loading ? (
          ...
          <div className="lg:col-span-4">
            {estimate ? (
              <div className="relative group overflow-hidden rounded-[2.5rem] bg-surface p-8 md:p-10 text-white shadow-2xl flex flex-col transition-all hover:scale-[1.01] h-fit sticky top-24">
                ...
                <div className="relative z-10 flex flex-col">
                  ...
                  <div className="space-y-4 flex-1">
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] font-black uppercase tracking-widest text-dim">Base Shipping</span>
                    ...
                    {estimate.breakdown?.handling_fee?.amount > 0 && (
                      <div className="flex justify-between items-center">
                        <span className="text-[10px] font-black uppercase tracking-widest text-dim">Handling Fee</span>
                    ...
                    {estimate.breakdown?.insurance?.included && (
                      <div className="flex justify-between items-center">
                        <span className="text-[10px] font-black uppercase tracking-widest text-dim">Insurance</span>
                    ...
                    <div className="flex justify-between items-center pb-6 border-b border-slate-700/50">
                      <span className="text-[10px] font-black uppercase tracking-widest text-dim">Customs Est.</span>
                    ...
                    <div className="pt-2 flex justify-between items-end">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-[9px] font-bold text-dim uppercase tracking-widest mt-2">{estimate.notes?.delivery_time}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="relative overflow-hidden rounded-[2.5rem] bg-surface-2 backdrop-blur-md border border-line p-8 md:p-10 text-center flex flex-col items-center justify-center h-64 sticky top-24 shadow-sm">
                <Package size={40} className="text-mute mb-4 opacity-50" />
                <p className="text-mute font-bold text-sm">Your final cost will be calculated once our warehouse team measures and weighs your package.</p>
              </div>
            )}
          </div>
        </div>
